...
class TestCase:
    ...
    def run_test(self) -> bool:
        ...
        os.system(run_prefix + " xelab  --incr --debug typical --relax --mt 2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot RISCV_behav xil_defaultlib.RISCV xil_defaultlib.glbl -log elaborate.log")
        os.system(run_prefix + " xsim  RISCV_behav -key {Behavioral:sim_1:Functional:RISCV} -tclbatch RISCV.tcl -log simulate.log")
        os.chdir(cur_path)
